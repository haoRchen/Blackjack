...
namespace bj {
	...
	int blackjack::handValue(int cardsInHand, card* hand[])
	{
		...
		cout << "hand value checked: " << sum << endl;//testing function call
				...
				case 1://new game, 
				{
					...
					while (playerHasMoney() && inGameOption != 0)
					{
						...
						do{
							...
							cout << "Chips Remaining: " << player_->getChips() << endl;
						...
						{//player menu
							...
							switch (inGameOption)
							{
								...
								case 2:
								{
									showHands(houseCardNum, house, playerCardNum, humanPlayer, true);
